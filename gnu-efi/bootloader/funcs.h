...
*/
void PrintMemMapDescriptors(kernel_header_t* map);
...
/* 
    ...
    * 
    * __kernel_header_t* header       - a pointer to where the kernel header resides in the previous stack. We'll supply the kernel with the info in this header.
