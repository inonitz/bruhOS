#ifndef __KERNEL_C_LOCAL_ADVANCED_PROGRAMMABLE_INTERRUPT_CONTROLLER_HEADER__
#define __KERNEL_C_LOCAL_ADVANCED_PROGRAMMABLE_INTERRUPT_CONTROLLER_HEADER__
#include <stdint.h>
...
typedef struct __local_apic_large_register
{
    LAPIC_REG reg0;
    LAPIC_REG reg32;
    LAPIC_REG reg64;
...
typedef struct alignpk(0x10) __local_apic_type
{
...
typedef struct __local_vector_table_timer_register
{
    union {
        struct pack {
            uint8_t vecnum    : 8;
...
typedef struct __local_vector_table_cmci_register
{
    union {
        struct {
            uint8_t  vecnum     : 8;
...
typedef struct __local_vector_table_local_interrupt_n_register
{
    union {
        struct {
            uint8_t  vecnum     : 8;
...
typedef struct __local_vector_table_error_register
{
    union {
        struct {
            uint8_t  vecnum     : 8;
...
typedef struct __local_vector_table_performance_monitor_counters_register
{
    union {
        struct pack {
            uint8_t vecnum     : 8;
...
typedef struct __local_vector_table_thermal_sensor_register
{
    union {
        struct pack {
            uint8_t vecnum     : 8;
...
typedef struct __interrupt_command_register
{
    union {
        struct {
            uint8_t  vecnum    : 8;
...
/*
    [TODO]: Type definition is incorrect
    recheck
*/
typedef struct __spurious_interrupt_vector_register
{
    union { 
        struct {
            uint8_t  vecnum     : 8;
...
typedef struct __divide_configuration_register
{
    union {
        // formula:
...
*/
extern bool_t lapic_pending(void);


#endif /* __KERNEL_C_LOCAL_ADVANCED_PROGRAMMABLE_INTERRUPT_CONTROLLER_HEADER__ */
