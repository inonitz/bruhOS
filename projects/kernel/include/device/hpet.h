...
extern uint64_t hpet_read_reg   (uint64_t reg_base, uint16_t offset               );
extern void     hpet_write_reg  (uint64_t reg_base, uint16_t offset, uint64_t data);
...
/* 
    ...
    * uint64_t nanoseconds - the amount of nanoseconds the timer will count.
*/
void     hcountns(uint64_t nanoseconds);


/*
    * Prepares the timer to start counting in milliseconds.
    * When ready, hpetEnable() should be used to utilize the timer.
    * uint64_t milliseconds - the amount of milliseconds the timer will count.
*/
...
/*
    * Prepares the timer to start counting in nanoseconds.
    * When ready, hpetEnable() should be used to utilize the timer.
    * uint64_t nanoseconds - the amount of nanoseconds the timer will count.
*/
