#ifndef __KERNEL_C_DEFINITION_PHYSICAL_MEMORY_MANAGER__
#define __KERNEL_C_DEFINITION_PHYSICAL_MEMORY_MANAGER__
...
typedef struct __managed_zone
{
    ...
    atomic8u_t      isusing;   // if a thread is using this allocator it'll set this variable.
} managed_zone;
