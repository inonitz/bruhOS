#ifndef __KERNEL_C_DEFINITION_MULTI_PROCESSOR_TRAMPOLINE_LINKER_SCRIPT_VARIABLES__
#define __KERNEL_C_DEFINITION_MULTI_PROCESSOR_TRAMPOLINE_LINKER_SCRIPT_VARIABLES__
...
typedef struct alignsz(4) __far_pointer_for_protected_mode
{
    uint32_t ptr;
    uint16_t segment;
} far_ptr32_t;
...
typedef struct alignsz(8) __far_pointer_for_long_mode
{
    uint32_t ptr;
    uint16_t segment;
} far_ptr64_t;
